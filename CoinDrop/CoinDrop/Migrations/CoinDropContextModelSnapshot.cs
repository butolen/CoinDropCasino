...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoinDrop.SystemSetting", b =>
                {
            ...
            modelBuilder.Entity("CoinDrop.Withdrawal", b =>
                {
                    b.HasBaseType("CoinDrop.Transaction");
            ...
            modelBuilder.Entity("CryptoDeposit", b =>
                {
                    b.HasBaseType("CoinDrop.Transaction");
                    ...
                    b.ToTable("crypto_deposit", (string)null);
                });

            modelBuilder.Entity("HardwareDeposit", b =>
                {
                    b.HasBaseType("CoinDrop.Transaction");
                    ...
                    b.ToTable("physical_deposit", (string)null);
                });
            ...
            modelBuilder.Entity("CoinDrop.Withdrawal", b =>
                {
                    b.HasOne("CoinDrop.Transaction", null)
                        .WithOne()
                        .HasForeignKey("CoinDrop.Withdrawal", "TransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("CryptoDeposit", b =>
                {
                    b.HasOne("CoinDrop.Transaction", null)
                        .WithOne()
                        .HasForeignKey("CryptoDeposit", "TransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("HardwareDeposit", b =>
                {
                    b.HasOne("CoinDrop.Transaction", null)
                        .WithOne()
                        .HasForeignKey("HardwareDeposit", "TransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
